...
Durante o desenvolvimento, foram aplicados conceitos fundamentais de design, como:

📐 Posicionamento estratégico dos visuais

🎨 Contraste e legibilidade

🌀 Proporção áurea para equilíbrio visual
...
Visualização de unidades vendidas e total de vendas
...
Correlação entre receita e lucro ao longo dos meses
...
Design inspirado em experiência do usuário (UX)

Melhoria da paleta de cores e contraste

Gráficos otimizados (coluna, matriz e área) para leitura intuitiva
